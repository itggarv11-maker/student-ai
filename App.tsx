...
const AppContent: React.FC = () => {
  useEffect(() => {
    ...
    const steps = [
        { text: "Waking up StuBro...", delay: 50 },
        { text: "Brewing some coffee...", delay: 800 },
        { text: "Organizing your notes...", delay: 800 },
        { text: "Ready to help! 🎉", delay: 500 },
    ];
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <Routes>
          ...
          <Route path="/focus-hub" element={<ProtectedRoute><FocusHubPage /></ProtectedRoute>} />
